...
MODULE DYNAMIC
  ...
  REAL(db)           :: pnrold(2)=(/0D0,0D0/) !<particle number of previous iteration
  REAL(db)           :: ehfold=0D0            !<HF energy of previous iteration
  REAL(db)           :: eintold=0D0           !<integrated energy of previous iteration
  REAL(db)           :: ekinold=0D0           !<kinetic energy of previous iteration 
  REAL(db)           :: ecollold(2)=0D0       !<collective energy of previous iteration
CONTAINS
!---------------------------------------------------------------------------  
