...
!    FFTW_planflag=FFTW_MEASURE+FFTW_UNALIGNED
    ...
    CALL dfftw_plan_many_dft(xbackward,1,(/nx/),2*ny*nz, &
         ...
         FFTW_BACKWARD, FFTW_planflag)
!guru    CALL dfftw_plan_guru_dft(yforward,1,ny,nx,nx, &
!guru         3,(/nx,nz,2/),(/1,nx*ny,nx*ny*nz/),(/1,nx*ny,nx*ny*nz/), &
!guru         p(:,:,:,:,1),p(:,:,:,:,2), &
!guru         FFTW_FORWARD, FFTW_MEASURE+FFTW_UNALIGNED)
!guru    CALL dfftw_plan_guru_dft(ybackward,1,ny,nx,nx, &
!guru         3,(/nx,nz,2/),(/1,nx*ny,nx*ny*nz/),(/1,nx*ny,nx*ny*nz/), &
!guru         p(:,:,:,:,1),p(:,:,:,:,1), &
!guru         FFTW_BACKWARD, FFTW_MEASURE+FFTW_UNALIGNED)
!guru    CALL dfftw_plan_guru_dft(zforward,1,nz,nx*ny,nx*ny, &
!guru         3,(/nx,ny,2/),(/1,nx,nx*ny*nz/),(/1,nx,nx*ny*nz/), &
!guru         p(:,:,:,:,1),p(:,:,:,:,2), &
!guru         FFTW_FORWARD, FFTW_MEASURE+FFTW_UNALIGNED)
!guru    CALL dfftw_plan_guru_dft(zbackward,1,nz,nx*ny,nx*ny, &
!guru         3,(/nx,ny,2/),(/1,nx,nx*ny*nz/),(/1,nx,nx*ny*nz/), &
!guru         p(:,:,:,:,1),p(:,:,:,:,1), &
!guru         FFTW_BACKWARD, FFTW_MEASURE+FFTW_UNALIGNED)
